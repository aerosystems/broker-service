...
const loggerGRPCAddress = "log-service:50001"
...
// authenticate tries to log a user in through the auth-service. It receives a json payload
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// create variable we'll read the response.Body from the auth-service into
...
// logItem logs an event using the log-service. It makes the call by pushing the data to RabbitMQ.
